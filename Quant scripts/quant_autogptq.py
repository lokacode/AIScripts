...
# Usage: python quant_autogptq.py <model name or path> <output folder> <dataset> --bits <bits> --group_size <group_size> --damp <damp> --desc_act <desc_act> --dtype <dtype> --seqlen <seqlen> --batch_size <batch_size> --stop_file <stop_file> --make_folders --device <device>
# Example: python quant_autogptq.py gpt2 gpt2_quant wikitext --bits 4 --group_size 128 --damp 0.01 --desc_act 0 --dtype float16 --seqlen 2048 --batch_size 1 --stop_file stop.txt --make_folders --device cuda:0
