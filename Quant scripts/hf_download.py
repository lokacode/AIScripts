# script to download a model from huggingface hub
# Usage: python hf_download.py <repo> <model folder> --log_every <log period> --cache_dir <cache dir> --branch <branch> --token <token> --symlinks <true|false|auto> --fast <1|0> --ignore <ignore patterns>
# Example: python hub_download.py --symlinks false "R136a1/MythoMax-L2-13B-exl2" "/content/Mytho"
